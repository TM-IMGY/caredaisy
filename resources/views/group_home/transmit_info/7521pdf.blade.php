    ...
    <div class="landscape">
      <div class="header">
        <div class="title">
          ...
          <div class="title_main">介護給付費等支払決定額内訳書&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
        </div>
      ...
      <div class="contents">
        <table class="table_contets">
          ...
          @endphp
          <tr>
            <td rowspan="2">審査決定</td>
            <td class="text_small">介護サービス費</td>
            ...
            <td class="money" rowspan="2">{{ $endFlag ? $t1NumberOfUnits : "" }}</td>
            <td class="money">{{ $endFlag ? $t1Amount : "" }}</td>
            <td class="money">{{ $endFlag ? $t1LongTermCareBenefits : "" }}</td>
            <td></td>
          </tr>
          <tr>
            <td class="text_small">特定入所者介護費等</td>
            <td><img class="diagonal" src="{{ $diagonal_base64 }}"></td>
            <td class="money">{{ $endFlag ? $t1NumberOfServiceForSpecial : "" }}</td>
            <td class="money">{{ $endFlag ? $t1DaysOfServiceForSpecial : "" }}</td>
            <td class="money">{{ $endFlag ? $t1NumberOfUnitsForSpecial : "" }}</td>
            <td class="money">{{ $endFlag ? $t1LongTermCareBenefitsForSpecial : "" }}</td>
            <td></td>
          </tr>
          ...
          <tr>
            <td class="text_small">特定入所者介護費等</td>
            <td><img class="diagonal" src="{{ $diagonal_base64 }}"></td>
            <td class="money">{{ $endFlag ? $t2NumberOfServiceForSpecial : "" }}</td>
            <td class="money">{{ $endFlag ? $t2DaysOfServiceForSpecial : "" }}</td>
            <td class="money">{{ $endFlag ? $t2NumberOfUnitsForSpecial : "" }}</td>
            <td class="money">{{ $endFlag ? $t2LongTermCareBenefitsForSpecial : "" }}</td>
            <td></td>
          </tr>
          <tr>
            <td rowspan="2">支払決定</td>
            <td class="text_small">支払決定</td>
            <td><img class="diagonal" src="{{ $diagonal_base64 }}"></td>
            <td class="money">{{ $endFlag ? $t3NumberOfService : "" }}</td>
            <td class="money">{{ $endFlag ? $t3DaysOfService : "" }}</td>
            <td class="money" rowspan="2">{{ $endFlag ? $t3NumberOfUnits : "" }}</td>
          ...
          <tr>
            <td class="text_small">特定入所者介護費等</td>
            <td><img class="diagonal" src="{{ $diagonal_base64 }}"></td>
            <td class="money">{{ $endFlag ? $t3NumberOfServiceForSpecial : "" }}</td>
            <td class="money">{{ $endFlag ? $t3DaysOfServiceForSpecial : "" }}</td>
            <td class="money">{{ $endFlag ? $t3NumberOfUnitsForSpecial : "" }}</td>
            <td class="money">{{ $endFlag ? $t3LongTermCareBenefitsForSpecial : "" }}</td>
            <td></td>
          </tr>
        </table>
      </div>
      <div class="footer">
        <p>&nbsp;</p>
        <p>※１．下段は特定入所者介護サービス費等です。</p>
        <p>※２．特定入所者介護サービス費等の件数、日数は再掲です。</p>
        <p>
          ※３．単位数、金額、保険者（公費負担者）負担金額（特定入所者介護費等）の各欄は介護保険給付と公費給付の合算です（生保単独を除く）。
        </p>
        <p>
          ※４．過誤調整の内訳については、介護給付費過誤決定通知書、介護給付費再審査決定通知書に記載しています。
        </p>
      </div>
    </div>
    @endfor
