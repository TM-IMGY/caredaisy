...
class MakeInvoiceRequest extends CareDaisyBaseFormRequest
{
    /**
    ...
    public function authorize()
    {
        if (
            ...
            $this::has('facility_user_ids') && $this->facility_user_ids != null
        ) {
            return $this->authorizeFacilityId($this->facility_id) &&
                $this->authorizeFacilityUserIds($this->facility_user_ids);
        }
        return false;
    }
