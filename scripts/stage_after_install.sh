...
aws s3 cp s3://caredaisy-stg-deploy/confidentials/.env.stage .env
aws s3 cp s3://caredaisy-stg-deploy/oauth/oauth-private.key storage/
aws s3 cp s3://caredaisy-stg-deploy/oauth/oauth-public.key storage/
chmod 750 .env
